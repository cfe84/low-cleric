...
describe("Task scheduler", () => {
  ...
  const scheduledBatch3: IScheduledBatch<Task> = { batch: batch3, leadTime: leadTime3, scheduledStartDate: new Date(2020, 4, 3, 1), scheduledFinishDate: new Date(2020, 4, 7, 1) }
